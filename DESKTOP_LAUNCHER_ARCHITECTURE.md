...
NetflixTorrent.exe
  -> bundled GUI
  -> backend executable, profiles worker,desktop
...
- Start backend executable voi `SPRING_PROFILES_ACTIVE=worker,desktop`.
- Cho backend healthy.
- Mo desktop GUI.
...
Java backend duoc luu tru tai `legacy/java-backend/` chi de tham khao migration.
